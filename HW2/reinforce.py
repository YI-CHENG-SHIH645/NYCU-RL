...
class Policy(nn.Module):
    ...
    def __init__(self):
        ...
        self.l1 = nn.Linear(self.observation_dim, self.hidden_size)
    ...
    def select_action(self, state):
        ...
        self.saved_actions.append(SavedAction(m.log_prob(action), np.nan))
    ...
    def calculate_loss(self, gamma=0.99):
        ...
        # normalize discounted rewards, without this line, the model never converge
        discounted_rewards = (discounted_rewards - discounted_rewards.mean()) / (
                    discounted_rewards.std() + 1e-9)

        for (log_prob, _), Gt in zip(saved_actions, discounted_rewards):
